      ...
      <SafeAreaView className="flex-1">
        ...
        >
          <ScrollView contentContainerStyle={{ paddingBottom: insets.bottom }}>
            ...
            {/* Upcoming Class Card */}
            <TouchableOpacity className="bg-white m-4 rounded-xl shadow-md">
            ...
            <View className="p-4 flex-row gap-4">
              <TouchableOpacity className="bg-white p-4 rounded-xl shadow-md w-[48%]">
                <View className="mb-3">
              ...
              <View className="bg-white p-4 rounded-xl shadow-md w-[48%]">
                ...
                <TouchableOpacity className="bg-[#FF8C00] p-3 rounded-lg items-center">
